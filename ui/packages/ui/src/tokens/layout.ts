...
export const Layout = {
  /**
   * 侧栏展开：设备卡 + 图标与标题。对照鸿蒙效率型导航，比旧 232 收一档；
   * 与质量栏 / 命令组上限同档 200vp，仍够四字模块名。
   */
  ShellNav: 200,
  /**
  ...
  ShellNavIcons: 48,
  /**
   * 命令库分栏（终端左栏）。对照鸿蒙效率型 B 栏 / 预览同档 240vp，
   * 且 ≤ 窗口 40%；比旧 280 收一档，把主任务区留给执行结果。
   */
  Sidebar: 240,
  Preview: 240,
   ...
   * 宽：导航 200 + 操作栏 48 + 质量栏 200 + 间隙/垫 ~36 + 画面≥320 ≈ 804 → 1024。
